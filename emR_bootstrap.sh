...
sudo git clone https://github.com/amplab-extras/SparkR-pkg.git
cd SparkR-pkg
sudo USE_YARN=1 SPARK_VERSION=1.3.0 SPARK_YARN_VERSION=2.5.0 SPARK_HADOOP_VERSION=2.5.0 ./install-dev.sh
sudo cp -a /home/hadoop/SparkR-pkg/lib/SparkR /usr/share/R/library/
export YARN_CONF_DIR=/etc/hadoop/conf
